	...
	t.tracking = t.tracking || {}, tracking.inherits = function (t, r) {
		...
		tracking.initUserMedia_ = function (r, n) {	
			t.navigator.mediaDevices.getUserMedia({
				...
				alert("1.Please allow camera access in browser. " +
			    		"\n    \u2022 Click on the 3 dots on top right corner of Chrome"+
			    		"\n    \u2022 Click on settings from dropdown"+
			    		"\n    \u2022 Click on Site Settings in Advanced section"+
			    		"\n    \u2022 Click on Camera and give access"+
			    		"\n2.Please enable pop-ups in browser. " +
			    		"\n    \u2022 Got to site settings as above"+
			    		"\n    \u2022 Click on Pop-ups and redirect and enable Pop-ups"+
			    		"\n3.Clear blocked sites." +
			    		"\n    \u2022 Got to Camera from Site Settings as above"+
			    		"\n    \u2022 You can see if any link is blocked"+
			    		"\n    \u2022 Long tap on the blocked link"+
